...
As a point of interest, we can use the `summary` function on our final model object to give us a variable importance plot. Not surprisingly, `city`and `experience` are the most important variables in the model. This aligns closely with what we saw as the important features in our random forest model. 
