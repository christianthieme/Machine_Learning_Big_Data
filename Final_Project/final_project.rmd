...
fviz_nbclust(kmeans_trans, kmeans, method = "wss", k.max = 20)
=======
# library(factoextra)
# 
# factoextra::fviz_nbclust(kmeans_trans, kmeans, method = "silhouette", k.max = 20)
>>>>>>> da1de191cefd2e521e5440571538b7e17a63f117
```
...
What incredible clusters! To get a sense of our clusters, we first performed computed the principle components of the original data via PCA. We then graphed the contribution of each variable to the top two dimensions in our PCA.
